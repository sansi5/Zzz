...
TOKEN = '7690334812:AAHjJaeK_QK31DH7nk-yHdlgHplSsPCnnqg'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002283293713
CHANNEL_ID = -1002283293713
error_channel_id = -1002283293713
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@The_Sensi*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :- @The_Sensi*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("SENSI SERVER RUNNING.....")
    while True:
        try:
